...
export function ComputerUsePage() {
  ...
  async function load() {
    ...
    setError("");
    try {
      const [toolData, doctorData] = await Promise.all([api.getTools(), api.doctor()]);
      setTools(toolData);
        ...
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              Give Hermes the tools it needs to operate your Mac: browser, terminal, files, screen understanding, memory, voice, and scheduled tasks.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
            ...
            <aside className="space-y-4">
              <StatusPanel doctor={doctor} ready={ready} requiredReady={requiredReady} recommendedReady={recommendedReady} />
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                ...
                <div className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <Prompt>Open a browser and search for today's top AI agent news.</Prompt>
                  <Prompt>Look at my screen and tell me what I should fix next.</Prompt>
                  <Prompt>Schedule a calendar event for tomorrow at 9 AM.</Prompt>
                </div>
